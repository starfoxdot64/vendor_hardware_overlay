...
echo ""
echo "This script does not look for blacklisted keys, so"
echo "you may still have a few keys in the XML that will"
echo "require manual removals. It's better than dozens!"
echo ""
echo ""